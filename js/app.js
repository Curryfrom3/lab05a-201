...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let product2 = multiply(product, c);
  let product3 = product2[0];

  let message1 = `${a} and ${b} and ${c} sum to ${sumValue3}.`;
  let message2 = `The product of ${a} and ${b} and ${c} is ${product3}.`;
  return [sumValue3, product3, message1, message2];
}
